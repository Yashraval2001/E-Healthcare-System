                ...
                <div class="row">
                    ...
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist" style="width: 50%;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#chemist" role="tab" aria-controls="chemist" aria-selected="false">chemist</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show" id="chemist" role="tabpanel" aria-labelledby="profile-tab">
                                <h3  class="register-heading">Login as chemist</h3>
                                <form method="post" action="Chemist func3.php">
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="User Name *" name="username3" onkeydown="return alphaOnly(event);" required/>
